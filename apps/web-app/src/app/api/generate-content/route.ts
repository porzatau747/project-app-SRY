...
เขียนคอนเทนต์ภาษาไทยแบบเป็นกันเอง อ่านง่าย น่าสนใจ และเป็นประโยชน์`;
    ...
    if (template === "free-text") {
      ...
      บังคับให้แสดงผลลัพธ์เป็น JSON format เท่านั้น ห้ามมีข้อความอื่นปน โดยใช้โครงสร้างดังนี้:
      {
        "intro": "สร้างภาพคอนเทนต์โฆษณาโปรโมทขายเก้าอี้เกมมิ่ง สไตล์ตามเทรนไอทีในปัจจุบัน และมีมไวร่อลปัจจุบันในประเทศไทย ให้กระชับและดึงดูดคน และไม่รก โดยใช้ข้อมูลทั้งหมดนี้:",
        "topic": "(พาดหัวหลักเก้าอี้เกมมิ่ง เช่น 'นั่งจนลืมเจ็บ... ตัวจบสายปวดหลัง' หรือพาดหัวดึงดูดสายตา)",
        "hook": "(ประโยค Hook ที่วิเคราะห์จาก: 'ทำไมถึงต้องซื้อสินค้านี้' เพื่อดึงดูดความสนใจ)",
        "productName": "(ชื่อและรุ่นของเก้าอี้เกมมิ่ง)",
        "priceTag": "(ราคาพิเศษตัวใหญ่ๆ และราคาปกติขีดฆ่า เช่น 'ราคาพิเศษ X บาท จากปกติ Y บาท')",
        "useful": "(ประโยชน์การใช้งานจริงของเก้าอี้ต่อการใช้ชีวิต/ทำงาน/เล่นเกม เช่น ท่านั่งสบาย การรับแรงกดทับ)",
        "product": "(ประสิทธิภาพและรายละเอียดสเปคของสินค้าจริงที่คุณวิเคราะห์มาจากการค้นหาอินเทอร์เน็ตเพื่อตอบโจทย์ประโยชน์)",
        "memeAngle": "(มุกตลก หรือมีมไวรัลกระแสปัจจุบันในไทยสำหรับนำมาสอดแทรกประกอบเป็นกิมมิคเล็กๆ ในภาพ)",
        "location": "Advice สามร้อยยอด",
        "visualDirection": "(อ้างอิงรายละเอียดองค์ประกอบโทนภาพจากหมวด 2. Chair ใน Design Guidelines ให้เน้นสไตล์ไอที แสงนีออนสะดุดตา อัตราส่วน 4:5 และบังคับสั่งให้นำภาพถ่ายจริงของเก้าอี้มาวางซ้อนประกอบร่วมในตัวภาพด้วย)",
        "layout": "(อ้างอิงเลย์เอาต์การจัดวางจากหมวด 2. Chair ใน Design Guidelines จัดสรรสัดส่วนภาพ 4:5 ให้มีพื้นที่แสดงรูปเก้าอี้ตัวหลักขนาดใหญ่ชัดเจน พื้นที่รายละเอียดสเปคและมุกมีมกิมมิคแบบสะอาดตาไม่รก)",
        "imagePrompts": [
          "(สร้าง Prompt ภาษาอังกฤษแบบละเอียดสูงสำหรับสั่ง DALL-E 3 วาดภาพ โดยระบุสัดส่วนเป็น 4:5 --ar 4:5 และมีคำสั่งเตรียมพื้นที่สำหรับวางรูปถ่ายเก้าอี้จริง โทนสีและแสงนีออน Cyberpunk ล้ำสมัยตามที่วิเคราะห์ไว้)"
        ]
      }
      \nเอกสารอ้างอิงการออกแบบ (Design Guidelines):\n${designGuide}`;
