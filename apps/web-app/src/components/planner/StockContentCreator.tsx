...
บังคับให้แทรกข้อมูลติดต่อด้านล่างสุดของภาพในสไตล์ Modern IT หรือ Cyberpunk/Glassmorphism ให้ดูหรูหรา ล้ำสมัย และจัดวางให้คลีน ไม่อึดอัด
(ห้ามออกแบบให้ดูโบราณ บังคับใช้ฟอนต์แบบไม่มีหัว (Sans-serif) ที่ดูเป็นเทคโนโลยี ล้ำสมัย สะอาดตา และจัดอักษรให้อ่านง่าย):
- [ไอคอนโลโก้ LINE] @a0917611968
- [ไอคอนโทรศัพท์] 091-7611968
- ข้อความ: "มีบริการ รับ-ส่ง สินค้าและเครื่องซ่อม"`;
