...
export const FALLBACK_FLOOR_COLOR = '#1e1e1e';
...
export const VOID_TILE_OUTLINE_COLOR = 'rgba(255,255,255,0.03)';
...
export const CANVAS_FALLBACK_TILE_COLOR = '#111';
export const CANVAS_ERROR_TILE_COLOR = '#FF00FF';
export const WALL_COLOR = '#0a0a0a';
