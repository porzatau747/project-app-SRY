...
export function createDefaultLayout(): OfficeLayout {
  ...
  const furniture: PlacedFurniture[] = [
    // Trend Analyst (Top Left)
    { uid: 'desk1', type: 'DESK_FRONT', col: 2, row: 2 },
    { uid: 'pc1', type: 'PC_FRONT_OFF', col: 2, row: 2 },
    { uid: 'chair1', type: 'WOODEN_CHAIR_FRONT', col: 2, row: 3 },
    
    // Promo & Stock (Bottom Left)
    { uid: 'desk2', type: 'DESK_FRONT', col: 2, row: 7 },
    { uid: 'pc2', type: 'PC_FRONT_OFF', col: 2, row: 7 },
    { uid: 'chair2', type: 'WOODEN_CHAIR_FRONT', col: 2, row: 8 },
    
    // Creative (Top Right)
    { uid: 'desk3', type: 'DESK_FRONT', col: 12, row: 2 },
    { uid: 'pc3', type: 'PC_FRONT_OFF', col: 12, row: 2 },
    { uid: 'chair3', type: 'WOODEN_CHAIR_FRONT', col: 12, row: 3 },
    
    // Editor (Bottom Right)
    { uid: 'desk4', type: 'DESK_FRONT', col: 12, row: 7 },
    { uid: 'pc4', type: 'PC_FRONT_OFF', col: 12, row: 7 },
    { uid: 'chair4', type: 'WOODEN_CHAIR_FRONT', col: 12, row: 8 },
  ];
